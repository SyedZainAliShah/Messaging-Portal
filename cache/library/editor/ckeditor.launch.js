...
sakai.editor.editors.ckeditor.launch = function(targetId, config, w, h) {
    ...
    (function() {
        ...
        CKEDITOR.plugins.addExternal('image2',webJars+'image2/4.9.1/', 'plugin.js');

        //Autosave has a dependency on notification
        CKEDITOR.plugins.addExternal('autosave',webJars+'autosave/278c922c6d8529edd15a2b2c11b574fb4320e0c2/', 'plugin.js');
        CKEDITOR.plugins.addExternal('wordcount',webJars+'wordcount/136ba881ddcff5aa029e3648c69358c15a982afc/', 'plugin.js');
